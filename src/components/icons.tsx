...
export function ImageIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="m4 17 5-5 4 4 2-2 5 5" />
    </svg>
  )
}
...
export function VideoIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="m16 10 4.2-2.4a.55.55 0 0 1 .8.48v7.84a.55.55 0 0 1-.8.48L16 14" />
    </svg>
  )
}
